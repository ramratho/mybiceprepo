...
module newazureVirtualMachine '../../Modules_Infra/Compute/ubuntu20.04_VirtualMachine.bicep' ={
  ...
  params: {
           ...
           virtualMachineName: 'cwshubchn101'
           ...
           environment: 'Hub'
           applicationName: 'LinuxServer-VM'
...
var vmNameAsPrefixVar = 'cwshubchn101'
